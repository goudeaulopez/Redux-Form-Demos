...
class SimpleForm  extends React.Component{
    ...
    inputname = formvalue => {
        const classlabel = `${formvalue.meta.error && formvalue.meta.touched ? 'text-danger': 'text-primary' }`
        const classinput = `${formvalue.meta.error && formvalue.meta.touched ? 'border-danger':'border-primary'}`
         return(
             <div className="field">
    ...
    render(){
        ...
        return(
            <div className="simpleform">
               ...
               <h4 className="ui dividing header text-primary center aligned">{this.props.title}</h4>
